    ...
    return {
      ...
      seriesMovies: seriesResponse.movies ? seriesResponse.movies.map((movieInSeries: any) => {
        ...
        movie: {
          ...
          type: movieInSeries.type || 'N/A',
          posterUrl: "https://img.ophim.live/uploads/movies/" + movieInSeries.thumbUrl || '',
          thumbnailUrl: "https://img.ophim.live/uploads/movies/" + movieInSeries.moviePosterUrl || '',
